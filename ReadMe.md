A .NET wrapper for [tesseract-ocr] 5.4.0.
...
You will also need to download the language data files for tesseract 5.4.0 from [tesseract-ocr].
...
Copyright 2012-2024 Charles Weld.
